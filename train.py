...
parser.add_argument('--train_img', type=str, default='CNR-EXT-Patches-150x150/', help="path to training set images")
parser.add_argument('--train_lab', type=str, default='splits/CNRPark-EXT/train_days.txt', help="path to training set labels")
parser.add_argument('--test_img', type=str, default='CNR-EXT-Patches-150x150/', help="path to test set images")
parser.add_argument('--test_lab', type=str, default='splits/CNRPark-EXT/test_days.txt', help="path to test set labels")
